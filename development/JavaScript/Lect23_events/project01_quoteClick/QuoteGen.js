...
bgColour.style.backgroundColor = `rgba(${num1}, ${num2}, ${num3} , 0.1)`;

destination.style.color = `rgb(${num1}, ${num2}, ${num3} )`;
}
...
let dest = document.getElementById("button");


dest.addEventListener("click", printQuote)