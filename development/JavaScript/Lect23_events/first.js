...
function disp(){
let dest = document.getElementById("root");
let index = Math.floor(Math.random()*quotes.length);
dest.innerHTML = quotes[index];
}


// document.addEventListener("click" , disp);

// when we click a special ket - enter here
...
// when we click any key

document.addEventListener("keydown" , disp)
